 ...
 function friendship() {
     ...
     for (let x in master.mstSvt) {
         if ((master.mstSvt[x].type == 1 || master.mstSvt[x].type == 2 || master.mstSvt[x].type == 99) && master.mstSvt[x].collectionNo > 1) {
             ...
             var id = 0;
             var name = "";
             for (let a in master.mstFriendship) {
 ...
 function detailInfo() {
     ...
     for (let x in master.mstSvt) {
         ...
         for (let z in servantsWhiteList) {
         ...
         if ((master.mstSvt[x].type == 1 || master.mstSvt[x].type == 2 || master.mstSvt[x].type == 99) && master.mstSvt[x].collectionNo >= 0) {
             ...
             if (master.mstSvt[x].collectionNo > 1) {
                 ...
                 for (let j in master.mstFriendship) {
                 ...
                 if (master.mstCombineSkill[i].id == master.mstSvt[x].id) {
                     for (let j in master.mstCombineSkill[i].itemIds) {
                         ...
                         if (!itemsPath[master.mstCombineSkill[i].itemIds[j]]) {
                             console.log("------------item icon------------");
                             console.log(master.mstCombineSkill[i].itemIds[j], findItemName(master.mstCombineSkill[i].itemIds[j]), itemsDict[master.mstCombineLimit[i].itemIds[j]]);
                         }
     ...
     removeItems();
     $("#info").append("<code id='info-str'></code>");
     $("#info-str").append(JSON.stringify(lists).replace(/<(.*?)>/g, "&lt;$1&gt"));
 }
